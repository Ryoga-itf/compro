...
#let project(week: 0, authors: (), date: none, body) = {
  let title = "コンピュータとプログラミング - C言語 第" + str(week) + "回 課題";
  ...
  set text(font: fontSerif, lang: "ja", size: 9.84pt)
